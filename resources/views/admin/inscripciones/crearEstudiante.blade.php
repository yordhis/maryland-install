                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <div class=" pb-2">
                                    ...
                                    <p class="text-center text-danger small">Ingrese la cédula del estudiante para cargarlo a la planilla, en caso de no estar registrado se cargará un formulario para registrarlo</p>
                                </div>
                                <form class="row g-3 needs-validation" novalidate>
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group has-validation" >
                                            ...
                                            required>
                                            <button class="input-group-text btn btn-primary" type="submit" id="buscarEstudiante">Cargar</button>
