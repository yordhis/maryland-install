                                            ...
                                            <form action="{{ route('admin.estudiantes.store') }}" method="POST"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group has-validation">
                                                        ...
                                                        <input type="text" name="nombre" class="form-control"
                                                            id="yourUsername" placeholder="Ingrese su nombres y apellidos"
                                                ...
                                                <div class="col-xs-12 col-sm-4">
                                                    ...
                                                    <input type="number" name="cedula" class="form-control"
                                                        id="yourUsername" placeholder="Ingrese número de cédula"
                                                ...
                                                <div class="col-xs-12 col-sm-4">
                                                    ...
                                                    <input type="number" name="telefono" class="form-control"
                                                        id="yourUsername" placeholder="Ingrese número de teléfono"
                                                ...
                                                <div class="col-xs-12 col-sm-4">
                                                    ...
                                                    <input type="email" name="correo" class="form-control"
                                                        id="yourUsername" placeholder="Ingrese dirección de correo."
                                                ...
                                                <div class="col-xs-12 col-sm-4">
                                                    ...
                                                    <input type="date" name="nacimiento" class="form-control"
                                                        id="yourUsername" placeholder="Ingrese fecha de nacimiento."
                                                ...
                                                <div class="col-xs-12 col-sm-4">
                                                    ...
                                                    <input type="number" name="edad" class="form-control"
                                                        id="yourUsername" placeholder="Ingrese edad."
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" name="grado" class="form-control"
                                                        id="yourUsername" placeholder="Ingrese grado de estudio."
                                                ...
                                                <div id="agregar-representante" class="row">
                                                    ...
                                                    <div class="col-1">
                                                        <span class="btn btn-none text-danger fs-3"
                                                            id="closeRepre">X</span>
                                                    </div>
                                                    ...
                                                    <div id="componenteRepresentante" class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6">
                                                            ...
                                                            <input type="number" name="rep_telefono"
                                                                class="form-control" value="{{ old('rep_telefono') }}"
                                                                id="yourUsername"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" name="rep_ocupacion"
                                                                class="form-control" value="{{ old('rep_ocupacion') }}"
                                                                id="yourUsername"
                                                        ...
                                                        <div class="col-12">
                                                            <label for="yourUsername" class="form-label">Dirección del
                                                                representante</label>
                                                            <input type="text" name="rep_direccion"
                                                                class="form-control" value="{{ old('rep_direccion') }}"
                                                                id="yourUsername"
                                                ...
                                                <div id="agregar-dificultad" class="row">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <input type="checkbox" name="dif_1" value="TDH"
                            ...
                            <div class="card-body">
                                ...
                                <div class=" pb-2">
                                    ...
                                    <p class="text-center text-danger small">Ingrese la cédula del estudiante para cargarlo
                                        a la planilla, en caso de no estar registrado puede registrar lo con el botón de arriba.</p>
                                </div>
