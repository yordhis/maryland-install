          ...
          <div class=" col-sm-12 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card ">
              ...
              <div class="card-body">
                ...
                <form action="/pagos" method="post" class="row g-3 needs-validation" target="_self" 
                ...
                novalidate>
                 ...
                 @method('post')  
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                          <span class="input-group-text text-white bg-primary" id="inputGroupPrepend">
                            <a href="#" target="_self" class="text-white fs-5" id="buscarEstudiante">
                        ...
                        <select name="concepto"  class="form-select" id="validationCustom04" required>
                          <option selected disabled value="">Seleccione Concepto</option>
                            ...
                            @foreach ($conceptos as $concepto)
                              <option value="{{$concepto->descripcion}}">{{$concepto->codigo}} - {{$concepto->descripcion}}</option>
                            @endforeach
                      ...
                      <div class="col-12" id="divMetodos">
                        ...
                        @foreach ($metodos as $metodo)
                          <div class="form-check form-check-inline">
                            ...
                            required
                            >
                            <label class="form-check-label" for="{{$metodo['metodo']}}">{{$metodo['metodo']}}</label>
                          </div>
                        @endforeach
                      </div>
